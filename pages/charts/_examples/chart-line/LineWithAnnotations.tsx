		...
		options: {
			annotations: {
				yaxis: [
					{
						y: 8200,
						borderColor: process.env.NEXT_PUBLIC_SUCCESS_COLOR,
						label: {
							borderColor: process.env.NEXT_PUBLIC_SUCCESS_COLOR,
							style: {
								color: '#fff',
								background: process.env.NEXT_PUBLIC_SUCCESS_COLOR,
							},
							text: 'Support',
						},
					},
					{
						...
						opacity: 0.2,
						label: {
							borderColor: process.env.NEXT_PUBLIC_WARNING_COLOR,
							style: {
								fontSize: '10px',
								color: '#333',
								background: process.env.NEXT_PUBLIC_WARNING_COLOR,
							},
							text: 'Y-axis range',
						},
					},
				...
				points: [
					{
						...
						label: {
							borderColor: process.env.NEXT_PUBLIC_DANGER_COLOR,
							offsetY: 0,
							style: {
								color: '#fff',
								background: process.env.NEXT_PUBLIC_DANGER_COLOR,
							},
