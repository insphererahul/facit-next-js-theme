...
$table-variants: (
  ...
  "dark":       $dark,
	...
	return (
		<PageWrapper>
			<Head>
				<title>{componentPagesMenu.content.subMenu.tables.text}</title>
			</Head>
			<SubHeader>
				<SubHeaderLeft>
					<Breadcrumb
							...
							<CardBody>
								<Card id='bordered-tables' className='scroll-margin rounded-2'>
									...
									<CardBody>
										...
										<p>
											<Link href='../utilities/borders/#border-color'>
						...
						<Card id='vertical-alignment' className='scroll-margin'>
							...
							<CardBody>
								<p>
									...
									<Link href='../utilities/vertical-align'>vertical align</Link>{' '}
