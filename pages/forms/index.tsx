...
const Index: NextPage = () => {
	...
	const forms: TMenu = componentPagesMenu.forms.subMenu;
	...
	return (
		<PageWrapper>
			<Head>
				<title>{`${componentPagesMenu.forms.text} List`}</title>
			</Head>
			<SubHeader>
				<SubHeaderLeft>
					<label
