...
<ChecksGroup
	...
	return (
		<PageWrapper>
			<Head>
				<title>{componentPagesMenu.forms.subMenu.checksAndRadio.text}</title>
			</Head>
			<SubHeader>
				<SubHeaderLeft>
					<Breadcrumb
				...
				<div className='row'>
							...
							<CardBody>
								<div className='row'>
									<FormGroup className='col-lg-6'>
										<Label htmlFor='exampleLabel'>With label</Label>
										<Checks
											type='checkbox'
											id='exampleLabelOne'
											label={
									...
									<FormGroup className='col-lg-6'>
										<Label htmlFor='exampleLabel'>Without label</Label>
										<Checks
											type='checkbox'
					...
					<div className='col-lg-6'>
						<Card stretch>
							...
							<CardBody>
								<FormGroup>
									<Label htmlFor='ChecksGroup'>
										Set as only the first two inline
									</Label>
									<ChecksGroup>
										<Checks
											type='checkbox'
